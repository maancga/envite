class_name TwelvePlayersTriumphHierarchy extends TriumphHierarchy

var triumphHierarchy: Array[Dictionary] = [
  { "value": ValueEnum.Value.AS, "suit": SuitEnum.Suit.OROS},
  { "value": ValueEnum.Value._2, "suit": SuitEnum.Suit.OROS},
